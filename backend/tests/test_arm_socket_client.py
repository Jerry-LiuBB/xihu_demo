...
class ArmSocketClientTests(unittest.TestCase):
    ...
    def test_build_wire_message_crlf(self):
        message = ArmSocketClient.build_run_trajectory_wire_message("1")
        self.assertEqual(message, b'{"command":"set_run_trajectory_file","name":"1"}\r\n')
